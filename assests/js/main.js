...
let swiperNew = new Swiper('.new__swiper', {
    ...
    slidesPerView: 'auto', // Automatically adjusts the number of slides based on their width

    breakpoints: {
        1150: {
            slidesPerView: 3, // When the viewport width is 1150px or more, show 3 slides per view
        }
    }
});
